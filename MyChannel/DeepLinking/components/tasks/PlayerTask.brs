...
sub PlayContentWithAds()
    ...
    ' This is the main entry point for instanttiating the ad interface
    ...
    while keepPlay
        ...
        if itemsCount - 1 > index
            ...
            ' Content details used by RAF for ad targetting
            ...
            if keepPlay = false
                ...
                bookmarks.RemoveSmartBookmarkForSeries(content.id)
            end if
        else
            if m.top.isSeries = true
