...
function ValidateDeepLink(args as Object) as Boolean
    ...
    return mediaType <> invalid and contentId <> invalid and types[mediaType] <> invalide
end function
...
sub PrepareDetailsScreen(content as Object)
    ...
    AddScreen(m.deepLinkDetailsScreen) ' add DetailsScreen to screen stack but don't show it
end sub
